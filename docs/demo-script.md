...
5. Change the amount to 4,800 USDC. Show routing to a native `TRANSFER` intent, its expiry and approval count, then open the generic Privy Dashboard approvals page.
